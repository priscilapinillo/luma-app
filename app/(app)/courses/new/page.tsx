  ...
  return (
    <div style={{padding:'20px',maxWidth:'720px',margin:'0 auto',paddingBottom:'80px'}}>
      ...
      <div className="field">
        ...
        <textarea value={form.descripcion_corta} placeholder="Aparece en la card del curso (máx 150 caracteres)" maxLength={150}
      ...
      <div className="field">
        ...
        <textarea value={form.descripcion_larga} placeholder="Contá en detalle de qué trata el curso."
      ...
      <div className="precio-row">
        ...
        <div className="field">
          ...
          <input type="number" min="0" step="0.5" value={form.duracion_estimada_horas} placeholder="Ej: 4.5"
      ...
      <div className="precio-row">
        <div className="field">
          ...
          <input type="number" min="0" value={form.dias_garantia} placeholder="Ej: 7"
            onChange={e => setForm({...form, dias_garantia: e.target.value})}/>
        </div>
        <div className="field">
          <label>Política de reembolso</label>
          <input value={form.politica_reembolso} placeholder="Ej: Reembolso completo en 7 días"
